...
{
    Console.WriteLine("Вторник - это будний день... Крепись!");
}
else if (dayNum == 3)
{
    Console.WriteLine("Среда - это будний день... Но, как говорится: среда - это маленькая пятница!");
}
else if (dayNum == 4)
{
...
{
    Console.WriteLine("Пятница - это будний день... Крепись! Выходные не за горами!");
}
else if (dayNum == 6)
{
